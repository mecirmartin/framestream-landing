          ...
          {({ open }) => (
            <>
              <Disclosure.Button
                ...
                className="px-2 py-1 text-gray-500 rounded-md lg:hidden hover:text-red-500 focus:text-red-500 focus:bg-red-100 focus:outline-none dark:text-gray-300 dark:focus:bg-trueGray-700"
              >
                <svg
